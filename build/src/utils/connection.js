...
var connection = {
    ...
    clear: function () {
        return __awaiter(this, void 0, void 0, function () {
            var connection, entities, _i, entities_1, entity, repository, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(_i < entities_1.length)) return [3 /*break*/, 6];
                        entity = entities_1[_i];
                        return [4 /*yield*/, connection.getRepository(entity.name)];
                    case 3:
                        repository = _a.sent();
